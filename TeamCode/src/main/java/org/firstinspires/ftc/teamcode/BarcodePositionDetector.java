...
public class BarcodePositionDetector extends LinearOpMode {
    ...
    private double leftBarcodeRangeBoundary = 0.6; //i.e 30% of the way across the frame from the left
    private double rightBarcodeRangeBoundary = 0.3; //i.e 60% of the way across the frame from the left
